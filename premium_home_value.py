...
def load_data():
    try:
        ...
        st.error("Failed to load housing data. Please try again later.")
        st.stop()
...
def set_theme(theme_name):
    try:
        ...
        st.warning("Theme configuration failed. Using default theme.")
...
def main():
    try:
        ...
        st.error("A critical error occurred. Please try refreshing the page or check back later.")
